...
const examTitles = {
  'ssc-je': 'SSC JE Electrical Engineering',
};
...
export default function ExamDetailPage() {
  ...
  useEffect(() => {
    document.title = `${examTitle} - SparkTest`;
  ...
  return (
    <div className="mock-tests-page">
      ...
      <section className="mock-tests-hero">
        <Link to="/exams" style={{ color: '#22C55E', fontWeight: 600, fontSize: '0.9rem', display: 'inline-flex', alignItems: 'center', gap: '0.25rem', marginBottom: '1rem' }}>
      ...
      <div className="test-grid">
        {loading ? (
          ...
          <p style={{ gridColumn: '1 / -1', textAlign: 'center', color: '#6B7280' }}>No categories found.</p>
        )}
